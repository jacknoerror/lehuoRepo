...
//		setId(R.id.jacktitle);
		mView = LayoutInflater.from(context).inflate(R.layout.jack_edit_with_add_minus	, this,true);
		...
		bLeft.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if(null!=onMinusListener) onMinusListener.edit(JackEditWam.this);
			}
		});
		bRight.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				if(null!=onAddListener) onAddListener.edit(JackEditWam.this);
			}
		});
